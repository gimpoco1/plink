export function SessionSkeleton() {
  return (
    <section className="homeList">
      ...
      <div className="sessionsToolbar sessionsToolbar--skeleton">
        <div className="sessionsToolbar__group">
          <div className="skeletonPill" />
          <div className="skeletonPill" />
          <div className="skeletonPill" />
        </div>
        <div className="skeletonPill skeletonPill--wide" />
      </div>
      <div className="gameRows">
        {Array.from({ length: 4 }).map((_, index) => (
          <div className="gameRowCard gameRowCard--skeleton" key={index}>
            <div className="gameRow__head">
              ...
              <div className="skeletonChip" />
            </div>
            <div className="gameRow__meta">
              <div className="skeletonText skeletonText--sm skeletonText--short" />
              <div className="skeletonText skeletonText--sm skeletonText--short" />
            </div>
          </div>
        ))}
